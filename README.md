...
| -- | --- |-------------------------------------------------------------------------|
| 1 | [v1-36-eks-1](https://distro.eks.amazonaws.com/kubernetes-1-36/kubernetes-1-36-eks-1.yaml) | [v1.36.0-rc.0](https://github.com/kubernetes/kubernetes/release/tag/v1.36.0-rc.0) |
### Kubernetes 1-35
